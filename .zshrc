...
alias kill='/bin/kill --verbose'
alias pkill='/usr/bin/pkill --ignore-case --full --echo'
alias k9='kill --signal 9'
alias pk9='pkill --signal 9'
...
#alias you-get='you-get --socks-proxy 127.0.0.1:7890'
